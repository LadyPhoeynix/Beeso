...
"""Verify that starting beeso with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start beeso with -h for help text")
        ...
        self.log.info("Start beeso with -version for version information")
