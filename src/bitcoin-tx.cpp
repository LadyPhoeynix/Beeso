...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s beeso-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  beeso-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beeso transaction") + "\n" +
              "  beeso-tx [options] -create [commands]   " + _("Create hex-encoded beeso transaction") + "\n" +
              "\n";
