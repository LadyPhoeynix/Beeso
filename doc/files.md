...
* beeso.conf: contains configuration settings for beesod or beeso-qt
* beesod.pid: stores the process id of beesod while running
...
* debug.log: contains debug information and general logging generated by beesod or beeso-qt
